...
var _mapRu = {
  ...
  L10n.settingsDoTutorialFooter:
      'Обучение кратко рассказывает как пользоваться Launcher',
  ...
  L10n.settingsAboutTitle: 'О Лаунчере',
  L10n.settingsAboutInfo:
      '''Launcher — приложение с открытым исходным кодом, созданное с помощью Flutter. Его главная миссия — быть минималистичным, удобным и практичным. Launcher фокусируется на улучшение продуктивности пользователей, убирая все ненужные цвета, действия и отвлечения.''',
  ...
  L10n.settingsAboutOssFooter:
      '''Launcher было бы невозможно создать без сторонних библиотек с открытым исходным кодом. В этом разделе можно просмотреть все библиотеки, которые используется в Launcher.''',
